...
The Okta_HasRoleAssignment edges connect users, groups, and applications to their respective [Okta_RoleAssignment](/opengraph/extensions/okta/nodes/okta_roleassignment) nodes. The [Okta_ScopedTo](/opengraph/extensions/okta/edges/okta_scopedto) edges connect the [Okta_RoleAssignment](/opengraph/extensions/okta/nodes/okta_roleassignment) nodes to the resources they are scoped to, such as the organization or specific groups or applications.
