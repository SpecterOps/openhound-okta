...
Okta_AgentPoolFor edges connect an AD [Okta_AgentPool](/opengraph/extensions/okta/nodes/okta_agentpool) to the backing [Okta_Application](/opengraph/extensions/okta/nodes/okta_application) used for directory integration.
```mermaid
graph TB
