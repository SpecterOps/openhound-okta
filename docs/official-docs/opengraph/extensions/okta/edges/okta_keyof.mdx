...
The traversable Okta_KeyOf edges represent the relationships between applications [Okta_Application](/opengraph/extensions/okta/nodes/okta_application) and their JWKs:
