...
icon: '/images/extensions/okta/okta_application.png'
---
...
![Okta Application scopes and roles in BloodHound](/images/extensions/okta/bloodhound-app-scopes.png)
...
![Okta AD agent settings](/images/extensions/okta/okta-ad-agent.png)
...
![Properties of the GitHub Application node](/images/extensions/okta/bloodhound-github-properties.png)
...
![Jamf Pro SWA settings](/images/extensions/okta/app-jamf-swa.png)
...
![Google Workspace sign-in protocol settings](/images/extensions/okta/app-google-protocol-selector.png)
...
![Okta SAML application in BloodHound](/images/extensions/okta/bloodhound-app-saml.png)
...
![Okta SWA application in BloodHound](/images/extensions/okta/bloodhound-app-swa.png)
...
![Okta application OIDC grants](/images/extensions/okta/app-oidc-grants.png)
